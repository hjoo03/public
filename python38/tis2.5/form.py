...
class Ui_SettingsWindow(object):
    def setupUi(self, SettingsWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(60, 50, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(60, 90, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButton.setGeometry(QtCore.QRect(550, 30, 141, 61))
        font = QtGui.QFont()
        ...
        self.current_label.setGeometry(QtCore.QRect(540, 150, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.saved_label.setGeometry(QtCore.QRect(540, 170, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_19.setGeometry(QtCore.QRect(180, 160, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_19.setFont(font)
        self.label_19.setObjectName("label_19")
        self.status = QtWidgets.QLabel(self.centralwidget)
        self.status.setGeometry(QtCore.QRect(600, 100, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.status.setFont(font)
        self.status.setObjectName("status")
        self.status_2 = QtWidgets.QLabel(self.centralwidget)
        self.status_2.setGeometry(QtCore.QRect(540, 100, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.e_saved_label.setGeometry(QtCore.QRect(540, 190, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.e_saved_label.setFont(font)
        self.e_saved_label.setObjectName("e_saved_label")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(370, 130, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_7.setFont(font)
        self.label_7.setObjectName("label_7")
        self.startrow_lb = QtWidgets.QLineEdit(self.centralwidget)
        self.startrow_lb.setGeometry(QtCore.QRect(450, 130, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.startrow_lb.setFont(font)
        self.startrow_lb.setObjectName("startrow_lb")
        self.sysres = QtWidgets.QComboBox(self.centralwidget)
        self.sysres.setGeometry(QtCore.QRect(160, 130, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.sysres.setFont(font)
        self.sysres.setObjectName("sysres")
        self.sysres.addItem("")
        self.sysres.addItem("")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(60, 130, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(340, 50, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.delayt = QtWidgets.QLineEdit(self.centralwidget)
        self.delayt.setGeometry(QtCore.QRect(450, 50, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.delayt.setFont(font)
        self.delayt.setObjectName("delayt")
        self.save = QtWidgets.QLineEdit(self.centralwidget)
        self.save.setGeometry(QtCore.QRect(470, 90, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.save.setFont(font)
        self.save.setObjectName("save")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(320, 90, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_9.setFont(font)
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(350, 10, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_3.setBuddy(self.minprice)
    ...
    def retranslateUi(self, SettingsWindow):
        ...
        self.sysres.setItemText(0, _translate("SettingsWindow", "125%"))
        self.sysres.setItemText(1, _translate("SettingsWindow", "100%"))
        self.label_3.setText(_translate("SettingsWindow", "시스템 배율"))
        self.label_8.setText(_translate("SettingsWindow", "Delay (sec) :"))
        self.delayt.setText(_translate("SettingsWindow", "200"))
        self.save.setText(_translate("SettingsWindow", "5"))
        self.label_9.setText(_translate("SettingsWindow", "Saving Frequency :"))
