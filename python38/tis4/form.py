...
class Ui_Window(object):
    def setupUi(self, Window):
        ...
        self.btn_start.setGeometry(QtCore.QRect(20, 380, 111, 41))
        ...
        self.progressBar.setGeometry(QtCore.QRect(147, 390, 191, 23))
        self.progressBar.setProperty("value", 0)
        self.progressBar.setTextVisible(False)
        self.progressBar.setObjectName("progressBar")
        self.line = QtWidgets.QFrame(self.centralwidget)
        self.line.setGeometry(QtCore.QRect(20, 360, 321, 16))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(20, 430, 321, 251))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.le_ocv_offset.setGeometry(QtCore.QRect(290, 320, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.le_ocv_offset.setFont(font)
        self.le_ocv_offset.setObjectName("le_ocv_offset")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(200, 320, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_7.setFont(font)
        self.label_7.setObjectName("label_7")
        self.le_ocv_confidence = QtWidgets.QLineEdit(self.centralwidget)
        self.le_ocv_confidence.setGeometry(QtCore.QRect(140, 320, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.le_ocv_confidence.setFont(font)
        self.le_ocv_confidence.setObjectName("le_ocv_confidence")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(20, 320, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.line_3 = QtWidgets.QFrame(self.centralwidget)
        self.line_3.setGeometry(QtCore.QRect(20, 270, 321, 16))
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(20, 290, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_9.setFont(font)
        self.label_9.setObjectName("label_9")
        self.lb_multifile = QtWidgets.QLabel(self.centralwidget)
        self.lb_multifile.setGeometry(QtCore.QRect(260, 10, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.lb_multifile.setFont(font)
        self.lb_multifile.setObjectName("lb_multifile")
    ...
    def retranslateUi(self, Window):
        ...
        self.le_loaddelay.setText(_translate("Window", "10"))
        ...
        self.le_ocv_offset.setText(_translate("Window", "1"))
        self.label_7.setText(_translate("Window", "offset (0-20)"))
        self.le_ocv_confidence.setText(_translate("Window", "0.9"))
        self.label_8.setText(_translate("Window", "confidence (0-1)"))
        self.label_9.setText(_translate("Window", "OpenCV Options"))
        self.lb_multifile.setText(_translate("Window", "File 0/0"))
